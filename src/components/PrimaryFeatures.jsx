                ...
                <Tab.List className="relative z-10 flex gap-x-4 whitespace-nowrap px-4 sm:mx-auto sm:px-0 lg:mx-0 lg:block lg:gap-x-0 lg:gap-y-1 lg:whitespace-normal">
                  {features.map((feature, featureIndex) => (
                    <div
                      key={feature.title}
                      className={clsx(
                        'group relative rounded-full py-1 px-4 transition-colors duration-medium ease-smooth-out hover:duration-fast lg:rounded-r-none lg:rounded-l-xl lg:p-6',
                    ...
                    >
                      <h3>
                        <Tab
                          className={clsx(
                            'font-display text-lg transition-colors duration-medium ease-smooth-out hover:duration-fast [&:not(:focus-visible)]:focus:outline-none',
                            selectedIndex === featureIndex
                      ...
                      <p
                        className={clsx(
                          'mt-2 hidden text-sm lg:block transition-colors duration-medium ease-smooth-out group-hover:duration-fast',
                          selectedIndex === featureIndex
                            ? 'text-white'
